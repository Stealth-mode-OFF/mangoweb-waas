      ...
      <div className="max-w-4xl mx-auto">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}
          ...
          <h2 className="text-2xl md:text-4xl font-black tracking-tight mb-4">
            Od cervna 2025 vas web <span className="text-amber-400">musi</span> splnovat zakon.
          </h2>
          <p className="text-zinc-400 max-w-2xl mx-auto mb-6 leading-relaxed">
            European Accessibility Act (EAA) vyzaduje WCAG 2.1 AA pro vsechny firmy s 10+ zamestnanci.
            Nesplneni = pokuta. Splnujete?
          </p>
